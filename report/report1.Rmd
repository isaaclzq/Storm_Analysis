...
The number of storms per year are 
```{r, echo=FALSE}
stormPerYear
...
The number of storms per year with winds >= 35 knots (tropical storms) are
```{r, echo=FALSE}
stormPerYear35
...
The number of storms per year with winds >= 64 knots (hurricanes) are
```{r, echo=FALSE}
stormPerYear64
...
The number of storms per year with winds >= 96 knots (major hurricanes) are
```{r, echo=FALSE}
stormPerYear96
...
The number of storms per month are 
```{r, echo=FALSE}
stormPerMonth
...
The number of storms per month with winds >= 35 knots (tropical storms) are
```{r, echo=FALSE}
stormPerMonth35
...
The number of storms per month with winds >= 64 knots (hurricanes) are
```{r, echo=FALSE}
stormPerMonth64
...
The number of storms per month with winds >= 96 knots (major hurricanes) are
```{r, echo=FALSE}
stormPerMonth96
...
The Annumal Average Number of storms are
```{r, echo=FALSE}
annual
```

The regression analysis 1: mean pressure and mean wind speed for each storm
```{r, echo= FALSE}
...
The regession analysis 2: median pressure and median wind speed for each storm
```{r, echo = FALSE}
...
# loading data
# =============================================================================
EastP<-read.csv('EastP.csv',skip = 1, header = TRUE)
NorthA<-read.csv('NorthA.csv', skip=1, header=TRUE)
